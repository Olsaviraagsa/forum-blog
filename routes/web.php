...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::post('forum/add-reply/{slug}', 'ForumController@addReply')->name('forum.add-reply');
    Route::get('forum/delete-reply/{slug}', 'ForumController@destroyReply')->name('forum.delete-reply');
});